...
// >> Copy audios-------------------------------------------------------------------------
gulp.task('audios', function(done) {
  gulp.src(config.audios.src)
    .pipe(plumber({errorHandler: notify.onError('Error: <%= error.message %>')}))
...
// >> Copy audios files--------------------------------------------
gulp.task('audios-dist', function(done) {
  gulp.src(config.audios.src)
    .pipe(plumber({errorHandler: notify.onError('Error: <%= error.message %>')}))
    .pipe(gulp.dest(config.audios.dist));
  done();
});
...
gulp.task('default', gulp.series(['clean','html', 'styles','scripts', 'images', 'audios','icons'], function(done) {
  browserSync.init({
    server : {
      baseDir: './public/'
    }
  ...
  gulp.watch(config.audios.src, gulp.series(['audios', 'bs-reload']));
...
gulp.task('docs', gulp.series(['clean-dist','html-dist','styles-dist','scripts-dist', 'images-dist', 'audios-dist' ,'icons-dist'], function(done) {
